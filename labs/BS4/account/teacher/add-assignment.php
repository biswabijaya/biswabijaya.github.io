...
$title = "Sandeepana Academy | Add Assignment";
                                ...
                                <table class="table table-hover">
                                    <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td>Assignment 2</td>
                                          <td class="td-actions text-right">
                                              <button type="button" rel="tooltip" title="Upload Assignment" class="btn btn-primary btn-simple btn-xs">
                                      ...
                                      <tr>
                                          ...
                                          <td><input type="text" placeholder="Add Assignment Name"></td>
                                          <td class="td-actions text-right">
                                              <button type="button" rel="tooltip" title="Add Assignment" class="btn btn-primary btn-simple btn-xs">
